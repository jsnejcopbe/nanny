...
<body>
	...
	<nav class="sh-top">
		<div class="top-con clearfix">
			<a href="${pageContext.request.contextPath}/index.html" class="col-xs-2 sh-icon-left">
		...
		<div id="block1">
			...
			<div class="row mo-con">
				<div class="col-xs-12 con-item">
					<span class="pull-left">账户余额</span>
					<span class="pull-right imp">¥${balance }</span>
				</div>
	...
	<input id="canUserBalance" type="hidden" value="${balance }">
