...
<html>
  ...
  <body>
    			...
    			<div class="row">
					...
					<div class="col-md-4">
						<div class="info-box  bg-warning  text-white">
							...
							<div class="info-details">
								<h4> 店铺余额  <span class="pull-right">${shopBalance }</span></h4>
								<%--<p> 本月收入 <span class="badge pull-right bg-white text-warning"> 78 <i class="fa fa-arrow-up fa-1x"></i> </span> </p>
							--%></div>
						</div>
					</div>
				</div>
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th><i class="fa fa-caret-right"></i> 下单用户</th>
    ...
    <script src="${pageContext.request.contextPath}/js/adutio.js?v=0.02"></script>
