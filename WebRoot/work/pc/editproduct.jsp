...
<body>
			...
			<div class="content">
				<div class="row">
					<div class="col-mod-12">
		                ...
		                <h3 class="page-header"><i class="fa fa-indent"></i> 编辑商品</h3>
					</div>
				</div>
							...
							<div class="panel-body nopadding">
								...
								<div>
									<%--<ul class="anchor">
										...
										<li>
											<a class="done" href="#step-3" data-toggle="tab" onclick="down()">
													...
													<form class="form-horizontal" role="form"  id="pro1">
														<div class="form-group">
										         			...
										         			<div class="col-lg-10 col-md-9">
										         				<input type="text" class="form-control form-cascade-control" placeholder="请输入商品名称" name="shName" value="${pro.name}">
										         			</div>
										         		</div>
										         		<c:if test="${shopid=='0'}">
										         		<div class="form-group">
										         			...
										         			<div class="col-lg-10 col-md-9">
										         				<input type="text" class="form-control form-cascade-control"  placeholder="请输入成本价格"  name="costPrice"  value="${pro.costPrice}" onkeyup="clearNoNum(this)">
										         			</div>
										         		</div>
										         		</c:if>
										         		<c:if test="${shopid=='0'}">
										         		<div class="form-group">
										         			...
										         			<div class="col-lg-10 col-md-9">
										         				<input type="text" class="form-control form-cascade-control" placeholder="请输入建议售价" name="shopPrice" value="${pro.price}" onkeyup="clearNoNum(this)">
										         			</div>
										         		</div>
										         		</c:if>
										         		<c:if test="${shopid!='0'}">
										         		<div class="form-group">
										         			...
										         			<div class="col-lg-10 col-md-9">
										         				<input type="text" class="form-control form-cascade-control" placeholder="请输入商品售价" name="shopPrice" value="${pro.price}" onkeyup="clearNoNum(this)">
										         			</div>
										         		</div>
										         		</c:if>
										         		<c:if test="${shopid!='0'}">
										         		<div class="form-group">
										         			...
										         			<div class="col-lg-10 col-md-9">
										         				<input type="text" class="form-control form-cascade-control" placeholder="请输入折扣价格" name="shopDisprice" value="${pro.disPrice}" onkeyup="clearNoNum(this)"> 
										         			</div>
										         		</div>
										         		</c:if>
										         		<div class="form-group">
										         			...
										         			<div class="col-lg-10 col-md-9">
										         				<input type="text" class="form-control form-cascade-control" placeholder="请输入商品库存" name="Inventory" value="${pro.inventory}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
										         			</div>
										         		</div>
										         		<div class="form-group">
										         			<label for="inputEmail1" class="col-lg-2 col-md-3 control-label">商品状态</label>
										         			<div class="col-lg-10 col-md-9">
										         				<c:if test="${pro.isUse=='0'}">
										         				<input name="isUse" type="radio" value="0"  class="flat-input" checked >&nbsp;上架
										         				<input name="isUse" type="radio" value="1" class="flat-input">&nbsp;下架
										         				</c:if>
										         				<c:if test="${pro.isUse=='1'}">
										         				<input name="isUse" type="radio" value="0"  class="flat-input"  >&nbsp;上架
										         				<input name="isUse" type="radio" value="1" class="flat-input" checked>&nbsp;下架
										         				</c:if>
										         			</div>
										         		</div>
										         		<div class="form-group">
												...
												<div class="form-group">
										          ...
										          <div class="col-lg-10 col-md-9" id="upfile">
										           <div class="drop"  id="imgPreview">
										          	<img id="preshow" src="${pro.cover}" style="width:100%; height: 100%;" name="img"> 
						             				<!-- <div id="imgPreview" style="width:73%;"></div> -->
										           </div>
													 <input type="hidden" name="fi" id="fi" value="${pro.cover}"/>
											...
											<form class="form-horizontal cacade-forms" name="signup_form" id="pro3">
										        ...
										        <div class="form-group">
										        	...
										        	<div class="col-lg-10 col-md-9">
										        		...
										        		<input class="form-control probrand" style="margin:0px;" size="20" placeholder="请输入品牌名称" type="text" name="brandName" value="${pro.brName}" readonly="readonly">
										        ...
										        <div class="form-group">
										        	...
										        	<div class="col-lg-10 col-md-9">
										        		<input type="hidden" name="code" id="code" value="${pro.proCode}"/>
										        		<a class="btn btn-success" href="javascript:createHtml()">编辑商品规格</a>
										        	</div>
										        </div>
										       <!--  <div class="form-group">
								...
								<div class="actionBar">
							    	...
							    	<a class="buttonFinish" href="javascript:updPro(${pro.id})">保存商品</a>
							    </div>
								</div>
							</div>
						</div>
	...
	<script src="${pageContext.request.contextPath}/work/pc/js/editproduct.js?v=0.01"></script>
	<script src="${pageContext.request.contextPath}/js/brand.js"></script>
	
	<script type="text/javascript">
		var um=UM.getEditor('myEditor');
	um.setContent('${pro.proDes}');
	 ...
	 var htmlContent="${fn:escapeXml(pro.proDes)}";
	</script>
</body>
</html>
