...
<body>
	<div class="site-holder">
				...
				<div class="row">
					<div class="col-mod-12">
						...
						<div class="form-group hiddn-minibar pull-right or-opt" style="padding-right: 10px;">
                            <a class="btn btn-info" href="${pageContext.request.contextPath}/admin/userOrderList.html?uid=${uid}">返回</a>
                        </div>
							...
							<div class="panel-body" style="padding: 0px;">
								<ul class="list-group">
									<li class="list-group-item">
										...
										&nbsp;
										<span>订单状态:</span>
										<span class="badge">${order.staName }</span>
									</li>
									<li class="list-group-item">
										<i class="iconfont-gl">&#xe62b;</i>
										&nbsp;
										<span>收货人:</span>
										<span style="float: right;">${order.recName }</span>
									</li>
									<li class="list-group-item">
										<i class="iconfont-gl">&#xe633;</i>
										&nbsp;
										<span>联系电话:</span>
										<span style="float: right;">${order.recTel }</span>
									</li>
									<li class="list-group-item clearfix">
										<i class="iconfont-gl">&#xe60e;</i>
										&nbsp;
										<span>收货地址:</span>
										<span style="float: right; width: 70%;">${order.address }</span>
									</li>
									<li class="list-group-item">
										<i class="iconfont-gl">&#xe630;</i>
										&nbsp;
										<span>下单时间:</span>
										<span style="float: right;">${order.createTime }</span>
									</li>
									<li class="list-group-item">
										<i class="iconfont-gl">&#xe627;</i>
										&nbsp;
						...
						<div class="panel panel-cascade">
							...
							<div class="panel-body">
								<table class="table users-table table-condensed table-hover">
									...
									<tbody>
										<c:forEach items="${order.company }" var="od">
							            <tr>
							             	<td class="prodes">
							             		<img src="${od.cover }">
							             		<span>${od.name }</span>
							...
							<div class="panel-footer">
								<div class="opt-msg"> 合计<span>¥${order.totalPrice }</span>元
								<span id="isvc"></span>
								<c:if test="${order.vcID!=0 }">
									(抵用金额:${order.svMoney }元)
								</c:if>
								(含配送费${order.fee }元)</div>
							</div>
						</div>
					</div>
				</div>
		...
		<input id="totalprice" type="hidden" value=${order.totalPrice }>
