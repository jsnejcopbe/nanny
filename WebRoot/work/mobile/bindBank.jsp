...
<!-- 头部菜单 开始 -->
		...
		<div class="m-pagecont" style="overflow-x: hidden;top:0px;">
			...
			<form  id="pro">
						...
						<li class="fm-item">
		        			<div class="fm-cont">
		         				<label class="fm-tle">银行</label>
		          				<div class="fm-right">
		          				    <select id="bank" name="bank" placeholder="请选择银行">
		      			...
		      			<li class="fm-item">
		        			<div class="fm-cont">
		          				...
		          				<div class="fm-right">
	            					<input type="text" class="ui-ipt" placeholder="填写银行卡卡号" id="bankcard" name="bankcard" value="" onkeyup="this.value=this.value.replace(/\D/g,'')">
		      			...
		      			<li class="fm-item">
		        			<div class="fm-cont">
		          				...
		          				<div class="fm-right">
          							<input type="text" class="ui-ipt" placeholder="请写姓名" id="uname" name="uname" value="">
						...
						<li class="fm-item">
		        			<div class="fm-cont">
		         				<label class="fm-tle">手机</label>
		          				<div class="fm-right">
		            				<input type="text" class="ui-ipt" placeholder="请填写手机号" id="tel" name="tel" onkeyup="this.value=this.value.replace(/\D/g,'')"  <c:if test="${ profile.qq!='null' }">value="${ profile.qq }" </c:if> >
		          				</div>
		          				<div class="fm-right">
		            				<a type="button" class="ui-ipt"  onclick="info()">短信验证</a>
		          				</div>
		        			</div>
		      			</li>
		      			<li class="fm-item">
				...
				<div class="pad-10 fixed mt-10 ">
			    	<a href="javascript:addbankcard()" class="ui-btn-4">保存</a>
    ...
    <script type="text/javascript">
	  ...
	  function addbankcard()
	  {
		  ...
		  $.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/users/bankBind.html",
                data:data,
                dataType: "text",
	...
	function codeChek(){
		if (wait == 0) {  
	    	...
	    	wait--;
	    	var param={
	    			"sURL":"${pageContext.request.contextPath}/obtainCode.html",
	  ...
	  function info() {
		 ...
		 $.ajax({
             type: "post",
             url: "${pageContext.request.contextPath}/fasongd.html",
             data:data,
             dataType: "text",
             success: function (msg) {
             	var data=eval('(' + msg + ')');
