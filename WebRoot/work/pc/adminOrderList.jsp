...
<body>
					...
					<div class="col-md-12">
						<div class="mail-options-nav clearfix">
						   <div class="pull-left" id="shop_query" style="margin-top: -15px;">
								<form id="queryForm" action="${pageContext.request.contextPath}/admin/order-1-${shid}.html">
							...
							<div class="pull-right" id="state_query">
								...
								--%><div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="${pageContext.request.contextPath}/admin/order-1-${shid}.html">全部</a></li>
										<li><a href="${pageContext.request.contextPath}/admin/order-1-${shid}.html?sta=0">待付款</a></li>
										<li><a href="${pageContext.request.contextPath}/admin/order-1-${shid}.html?sta=1">待发货</a></li>
										<li><a href="${pageContext.request.contextPath}/admin/order-1-${shid}.html?sta=2">已发货</a></li>
										<li><a href="${pageContext.request.contextPath}/admin/order-1-${shid}.html?sta=a">已关闭</a></li>
									</ul>
								</div >
									&nbsp;&nbsp;
									<div class="fresh">
									 	<a class="btn btn-info" href="${pageContext.request.contextPath}/admin/business.html">返回</a>
									</div>
							</div>
						</div>
								...
								<div class="col-md-12 or-it">
									<div class="it-tit">
										...
										<div class="pull-right">
											<a class="btn btn-info" href="${pageContext.request.contextPath}/admin/order-det-${od.orderCode }.html">查看详情</a>
	...
	new Pagin({
		    ...
		    $("#queryForm").attr("action","${pageContext.request.contextPath}/admin/order-"+page+"-${shid}.html");
		    $("#queryForm").submit();
		}
	});
