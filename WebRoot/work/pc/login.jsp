...
<html>
  ...
  <body class="templatemo-bg-gray">
	<div class="container">
		<div class="col-md-12">
			<h1 class="margin-bottom-15">欢迎登录掌上保姆管理后台</h1>
			...
			<form id="userform" class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form">				
		        	...
		        	<div class="col-md-12">
		        		<div class="control-wrapper">
		        			...
		        			<a id="reverifycode" href="javascript:changeCode()" class="pull-right" style="text-align: right;">
		        				<img id="m_captcha"  src="/nanny/verifycode.html" style="height: 40px;">
		        			</a>
		        		</div>
		        	</div>
		        </div>
		      ...
		      <!-- <div class="text-center">
		      	<a href="create-account.html" class="templatemo-create-new">创建新帐户 <i class="fa fa-arrow-circle-o-right"></i></a>	
		      </div> -->
		</div>
	</div>
