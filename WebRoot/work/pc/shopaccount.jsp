					...
					<div class="col-md-12">
						<div class="mail-options-nav clearfix">
							<div class="pull-left" id="shop_query" >
								<form action="${pageContext.request.contextPath}/shop/shopAccount.html?pageIndex=1&pageSize=${rec.size}" method="post" id="uForm">
							...
							<%-- <div class="pull-right" id="state_query">
								<form action="${pageContext.request.contextPath}/shop/shopAccount.html?pageIndex=1&pageSize=${page.pageSize}" method="post" id="uForm">
									...
									<a href="javascript:void(0)" class="btn btn-warning" data-id="0">退款</a> 
									<a href="javascript:void(0)" class="btn btn-success" data-id="1">充值</a>
									<a href="javascript:void(0)" class="btn btn-warning" data-id="2">付款</a>
							...
							<div class="pull-right" id="state_query">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="${pageContext.request.contextPath}/shop/shopAccount.html?state=-1">全部</a></li>
										<li><a href="${pageContext.request.contextPath}/shop/shopAccount.html?state=0">退款</a></li>
										<li><a href="${pageContext.request.contextPath}/shop/shopAccount.html?state=5">提现退款</a></li>
										<li><a href="${pageContext.request.contextPath}/shop/shopAccount.html?state=1">充值</a></li>
										<li><a href="${pageContext.request.contextPath}/shop/shopAccount.html?state=2">付款</a></li>
										<li><a href="${pageContext.request.contextPath}/shop/shopAccount.html?state=3">提现</a></li>
										<li><a href="${pageContext.request.contextPath}/shop/shopAccount.html?state=4">返现</a></li>
									</ul>
								</div>
							</div>
						</div>
								...
								<table class="table users-table table-condensed table-hover"
									...
									<c:forEach items="${rec.rec}" var="rec">
									 <tr class="tr">
													...
													</c:if> <c:if test="${loginUser.userID==rec.otherSide}">
...
new Pagin({
    ...
    $("#uForm").attr("action","${pageContext.request.contextPath}/shop/shopAccount.html?pageIndex="+page+"&pageSize="+size);
    $("#uForm").submit();
}
});
