...
<body>
	<div class="site-holder">
		...
		<div class="box-holder">
				...
				<div class="row">
					<div class="col-mod-12">
						<ul class="breadcrumb">
							...
							<li class="active">供应商品一览</li>
						</ul>
						<h3 class="page-header">
							<span id="span_title">供应商品列表 </span>
					...
					<div class="col-md-12">
						<div class="mail-options-nav clearfix">
							...
							<div class="pull-right">
								<!-- <a class="btn btn-primary" id="" href="javascript:getCheck2();"><i class="fa fa-edit"></i> 批量购物</a>  -->
								<!--  <a id="goods" class="btn btn-info" href="javascript:void(0)"><i class="fa fa-plus"></i>我要选货</a>   -->
								<a class="btn btn-primary" id="many_stock" href="javascript:void(0)"><i class="iconfont-gl">&#xe628;</i> 购物车</a> 
								...
								<table class="table table-striped table-bordered" id="protable">
									<thead >
											...
											<tr data-order="true" data-check="true" >
												...
												<th data-hide="proCode" style="display: none;"></th>
									...
									<tbody>
										<c:forEach  items="${objpro.product}" var="op">
											...
											<td><a class="btn btn-primary ch" href="javascript:void(0);">加入购物车</a></td>
			...
			<div class="right-sidebar right-sidebar-hidden" id="shop_query">
				<form class="form-inline" action="${pageContext.request.contextPath}/shop/shsupro.html?pageIndex=1&pageSize=${objpro.size}&suid=${suid}" method="post" id="sform">
					<div class="right-sidebar-holder">
						...
						<input type="hidden" id="checkarry" name="checkarry"  value="">
				...
				<div class="modal-body">
					  ...
					  <table class="table table-striped table-bordered">
						...
						<div class="col-xs-8 bt-tot">
							<span id="total-tex">共 </span>
							<input type="hidden" id="total" name="total">
							<input type="hidden" id="supid" name="supid" value="${suid}">
						</div>
	...
	<script src="${pageContext.request.contextPath}/work/pc/js/shopSupPro.js?v=0.01"></script>
<script>
...
new Pagin({
	    ...
	    /* location.href="userlist.do?pageIndex="+page+"&pageSize="+size; */
	   	 /* var obj= getCheck2();
	   	 jsonarry=obj.jsarry; */
	      $("#checkarry").val(JSON.stringify(jsonarry));
	    $("#sform").attr("action","${pageContext.request.contextPath}/shop/shsupro.html?pageIndex="+page+"&pageSize="+size+"&suid="+suid);
	    $("#sform").submit();
	}
});
	
	
	$("#protable").on("click",".ch",function(){
